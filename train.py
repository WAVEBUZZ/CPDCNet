...
if __name__ == "__main__":
    ...
    #   
    #   当model_path = ''的时候不加载整个模型的权值。"model_data/unet_vgg_voc.pth"
    #
    ...
    if Cuda:
        if distributed:
            ...
            model_train = torch.nn.parallel.DistributedDataParallel(model_train, device_ids=[0], find_unused_parameters=True)
        else:
