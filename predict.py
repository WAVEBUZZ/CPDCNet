...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------#
    test_interval = 100
    fps_image_path  = "VOCdevkit/VOC2007/JPEGImages/train_data_10_11.jpg"
    #-------------------------------------------------------------------------#
    ...
    dir_save_path   = "VOCdevkit/VOC2007/JPEGImages_out"
    #-------------------------------------------------------------------------#
    ...
    if mode == "predict":
        '''
        predict.py有几个注意点
        1、该代 .listdir()遍历文件夹，利用Image.open打开图片文件进行预测。
        ...
        '''
        img_dir = r'F:\PLT\unet-pytorch-main\VOCdevkit\VOC2007\JPEGImages'
        save_path = r'F:\PLT\unet-pytorch-main\VOCdevkit\VOC2007\Predict'
        ...
        for i in img_name_list:
            ...
            try:
                ...
                r_image.save(os.path.join(save_path, i))
